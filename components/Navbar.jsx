...
const Navbar = () => {
  return (
    ...
    <a href="#top">
        <Image src={assets.logo} className='w-28 cursor-pointer
        mr-14' alt="logo" />
    </a>
    ...
    <div>
        ...
        px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo' >Contact <Image src={assets.arrow_icon} className=
        'w-3' alt="arrow"/></a>
    </div>
    </nav> 
    </>
